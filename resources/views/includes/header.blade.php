                ...
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <a href="{{ route('ContactUs') }}"
                            class="text-gray-500 hover:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5  dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800">ContactUs</a>
                    </li>
            ...
            <div class="container mx-auto px-6 md:px-12 xl:px-32">
                <div class="text-center text-gray-800">
                    <div class="block rounded-lg shadow-lg px-6 py-12 md:py-16 md:px-12"
                        ...
                        <h1 class="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12"> {{$mainTitle}}<br /><span class="text-blue-600">{{ $subTitle }}</span></h1>
                    </div>
                </div>
            </div>
        </section>
