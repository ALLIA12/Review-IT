                    ...
                    <table class="min-w-full text-center">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                    <a class="hover:opacity-75" href="mailto:ALLIA1999@HOTMAIL.COM" target="_blank"
                                        rel="noreferrer">
                                        <svg width="30px" height="30px" class="inline" viewBox="0 0 48 48"
                                            version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                    <a class="hover:opacity-75" href="https://www.linkedin.com/in/abdulrahmanhakami-/"
                            ...
                            <tr class="border-b">
                                ...
                                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                    <a class="hover:opacity-75"
                                        href="https://www.linkedin.com/in/ahmed-alzahrani-4a4885247/" target="_blank"
                                        rel="noreferrer">
                                        <svg width="30px" height="30px" class="inline" viewBox="0 0 48 48"
                                            version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <tr class="border-b">
                                ...
                                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                    <a class="hover:opacity-75" href="https://www.linkedin.com/in/ali-habibullah/"
                                        target="_blank" rel="noreferrer">
                                        <svg width="30px" height="30px" class="inline" viewBox="0 0 48 48"
                                            version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <tr class="border-b">
                                ...
                                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                    <a class="hover:opacity-75" href="https://www.linkedin.com/in/marwan-al-jedaani/"
                                        target="_blank" rel="noreferrer">
                                        <svg width="30px" height="30px" class="inline" viewBox="0 0 48 48"
                                            version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <tr class="border-b">
                                ...
                                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                    yalsayegh@stu.kau.edu.sa
                                </td>
                                <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                    <a class="hover:opacity-75" href="https://www.linkedin.com/in/yousefalsayegh/"
                                        target="_blank" rel="noreferrer">
                                        <svg width="30px" height="30px" class="inline" viewBox="0 0 48 48"
                                            version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink">
