...
<body>
    <div class="flex flex-col h-screen">
        ...
        <div class="flex-grow"> @include('includes.info')
            ...
            <p class="text-3xl font-bold text-center capitalize lg:text-4xl underline decoration-sky-200">Submit
                feedback:
            </p>
                        ...
                        <div class="items-center justify-center bg-white w-[50rem]">
                            <div class="mx-3 text-center">
                                <fieldset class="bg-sky-100	rounded-lg">
                                    <legend class="pt-10 mb-3 block text-2xl font-medium text-[#07074D]">Contact
                                        Information:
                                    </legend>
                                    <div class="px-3">
                                        <div class="mb-5">
                                ...
                                <fieldset class="bg-sky-100	rounded-lg">
                                    ...
                                    <legend class="pt-10 mb-3 block text-2xl font-medium text-[#07074D]">Feedback:
                                    </legend>
                                    <div class="w-full px-3 py-3">
                                        <label for="comment"
                                            class="mb-3 block text-base font-medium text-[#07074D]">Your
                                    ...
                                    <div class="px-3">
                                        <div class="mb-5">
                                            <label for="satisfaction"
                                                class="mb-3 block text-base font-medium text-[#07074D]">
                                                How are you stasfied with our website?<span
                                                    class="text-red-500">*</span>
                                            </label>
                                            <div class='flex items-center justify-center'>
                                                <div
                                                    class='w-full max-w-lg px-20 py-8 mx-auto bg-white rounded-lg shadow-xl'>
